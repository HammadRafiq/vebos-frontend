...
import { servicesSocialIcons } from "@assets/images";
      ...
      <div className=" grid grid-cols-6 gap-4 ">
        <div className=" col-span-6 lg:col-span-4 space-y-6">
          ...
          <div className="lg:text-[96px] md:text-[60px] text-[48px]  font-bold lg:leading-[96px]">
            Our Services For Your <span className="decorated-header">Social Media</span> Growth
          </div>
        ...
        <div className=" col-span-6 lg:col-span-2 m-auto">
          <Image src={servicesSocialIcons} alt="service-social-icons" />
        </div>
      </div>
    </div>
  );
